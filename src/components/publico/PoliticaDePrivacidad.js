      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <section className="mb-12">
          ...
          <p className="text-white dark:text-gray-300 text-lg">
            En [Nombre de la Empresa], valoramos y respetamos la privacidad de
        ...
        <section className="mb-12">
          ...
          <p className="text-white dark:text-gray-300 text-lg">
            Recopilamos información personal cuando usas nuestros servicios,
            como tu nombre, dirección de correo electrónico, dirección IP y
            detalles de pago, entre otros.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <p className="text-white dark:text-gray-300 text-lg">
            Usamos la información que recopilamos para mejorar nuestros
            servicios, procesar pagos, mantenerte informado sobre
            actualizaciones y ofrecerte una experiencia personalizada.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <p className="text-white dark:text-gray-300 text-lg">
            ...
            personal que nos proporcionas. Sin embargo, no podemos garantizar la
            seguridad total de la información en línea.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <p className="text-white dark:text-gray-300 text-lg">
            No compartimos ni vendemos tu información personal a terceros sin tu
            consentimiento, excepto cuando sea necesario para cumplir con la ley
            o cuando esté relacionado con la operación de nuestros servicios.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <p className="text-white dark:text-gray-300 text-lg">
            Utilizamos cookies para mejorar la experiencia del usuario, analizar
            el tráfico del sitio y personalizar los contenidos que ofrecemos.
            Puedes configurar tu navegador para bloquear las cookies si lo
            prefieres.
          </p>
        </section>
        ...
        <section className="mb-12">
          ...
          <p className="text-white dark:text-gray-300 text-lg">
            ...
            favor contáctanos a través de la información de contacto
