...
function CotizarPrecio() {
  ...
  return (
    <div className="pt-36">
      <section className="h-screen flex items-center justify-center  px-4 transition-colors">
        <div className="w-full max-w-2xl border rounded-xl p-8 text-gray-800 dark:text-white bg-transparent border-gray-200 dark:border-white">
        ...
        <div className="flex space-x-4">
              <button
                type="submit"
                className="flex-1 font-semibold py-2 px-4 rounded-md transition button-yellow"
              >
              ...
              <button
                ...
                className="flex-1 font-semibold py-2 px-4 rounded-md transition btn-cancelar"
              >
                Limpiar campos
              </button>
            </div>
          ...
          <div className="mt-6 text-center">
            <Link to="/consultaservicios">
              <button className="inline-block font-semibold py-2 px-4 rounded-md transition btn-aceptar">
                Volver al catálogo
              </button>
            </Link>
          </div>
