...
import jsPDF from "jspdf"; // Importa jsPDF para generar archivos PDF
...
const ReportComponent = () => {
  const mockData = [
    { cliente: "Juan", tipoServicio: "Mantenimiento", mes: "Enero", rendimiento: 90 },
    { cliente: "Maria", tipoServicio: "Reparación", mes: "Febrero", rendimiento: 70 },
    { cliente: "Lucas", tipoServicio: "Diagnóstico", mes: "Marzo", rendimiento: 85 },
    { cliente: "Juan", tipoServicio: "Mantenimiento", mes: "Abril", rendimiento: 95 },
    { cliente: "Maria", tipoServicio: "Reparación", mes: "Mayo", rendimiento: 80 },
  ];
  ...
  return (
    <div className="p-6 bg-gray-100 dark:bg-gray-800 rounded-lg shadow-lg">
      ...
      <div className="flex gap-4 mb-6">
        ...
        <div>
          <label className="block text-yellow-400">Filtrar por Tipo de Servicio</label>
          <select
            className="form-input"
