...
export const updateService = async (serviceId, serviceData) => {
    try {
        const response = await api.patch(`/admin/update-service/${serviceId}`, serviceData);
        return response.data;
    } catch (error) {
...
export const updateVehicleType = async (vehicleId, vehicleData) => {
    try {
        const response = await api.patch(`/admin/update-vehicletype/${vehicleId}`, vehicleData);
        return response.data;
    } catch (error) {
...
export const updateBrand = async (brandId, brandData) => {
    try {
        const response = await api.patch(`/admin/update-brand/${brandId}`, brandData);
        return response.data;
    } catch (error) {
